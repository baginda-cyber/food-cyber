...
<link rel="stylesheet" href="style.css">
 ...
 <!-- Preloader -->
  ...
  <div id="wrapshopcart">
   ...
   <form action="pemesanan3.php" method="POST" onsubmit="validasi()">
   
   <input type="text" name="nama_depan" class="inputan" placeholder="Nama Anda" required=""> 
     <input type="submit" name="kirim" value="Kirim Isi Formulir!" class="submitbtn" style="cursor: pointer;" required="">
    <input type="text" name="no_hp" class="inputan" placeholder="No Hp" required="" />
 
  <label></label><input type="text" name="email" class="inputan" placeholder="Kabupaten" id="kabupaten" required="" />
 
   <label></label><textarea name="alamat" class="textan" placeholder="Alamat" required="" ></textarea><br>
   <i>Hanya untuk di kawasan Toba Samosir</i><br><br>
<br>    
 ...
 <script type="text/javascript">
     function validasi() {
        ...
        if (kabupaten != "toba samosir") {
            ...
            window.location="pemesanan2.php";
                           return false;
