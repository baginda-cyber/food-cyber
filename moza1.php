...
<link rel="stylesheet" href="style.css">
 ...
 <!-- Preloader -->
  ...
  <div id="wrapshopcart">
   ...
   <form action="moza2.php" method="POST" onsubmit="validasi()">
...
<a href="menu-minuman.php" ><input type="" name="menumakan" class="btn btn-success" value="Beli Minuman"></a>
 ...
 <br>
 <label></label><h6>Nasi Ayam Mozarella & Quantity</h6>
  <select name="productid"  ><option>Nasi Ayam Mozarella <?php $_SESSION['cart'] = array(
 ...
 <script type="text/javascript">
     function validasi() {
        ...
        if (kabupaten != "toba samosir") {
            ...
            window.location="http://localhost/pa1/delicious/moza1.php";
                           return false;
