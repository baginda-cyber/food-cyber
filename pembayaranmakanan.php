...
<link rel="stylesheet" href="style.css">
 ...
 <!-- Preloader -->
  ...
  <div id="wrapshopcart">
   ...
   <p>Silakan lengkapi form data diri di bawah ini untuk melanjutkan ke tahap pembayaran : </p>
    
   <form action="pembayaranmakanan2.php" method="POST">
   ...
   <input type="text" name="email" class="inputan" placeholder="Email" />
 
  <label></label> <input type="text" name="no_hp" class="inputan" placeholder="No Hp" />
 
   <label></label><input type="text" min="7" max="10" name="no_rekening" class="inputan" placeholder="No Rekening" />
   <label></label><input type="text" min="4" max="4" name="passs" class="inputan" placeholder="Pin" />
